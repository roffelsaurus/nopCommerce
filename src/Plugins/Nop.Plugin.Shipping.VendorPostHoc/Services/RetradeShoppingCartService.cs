...
namespace Nop.Plugin.Shipping.VendorPostHoc.Services
{
    ...
    /// </summary>
    public partial class RetradeShoppingCartService : IShoppingCartService
    {
        #region Fields
        ...
        public RetradeShoppingCartService(CatalogSettings catalogSettings,
