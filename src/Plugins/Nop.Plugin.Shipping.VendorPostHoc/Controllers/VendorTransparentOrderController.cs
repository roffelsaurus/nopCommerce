...
{
    public class VendorTransparentOrderController : OrderController
    {
        ...
        public override IActionResult EditOrderTotals(int id, OrderModel model)
        {
