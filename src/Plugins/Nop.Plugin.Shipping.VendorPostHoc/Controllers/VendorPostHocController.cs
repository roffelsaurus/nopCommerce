...
namespace Nop.Plugin.Shipping.VendorPostHoc.Controllers
{
    ...
    public class VendorPostHocController : BasePluginController
    {
        ...
        public IActionResult Configure()
        {
            ...
            {
                AllowedTotalShippingCostChange = _vendorPostHocSettings.AllowedTotalShippingCostChange
            };
        ...
        public IActionResult Configure(ConfigurationModel model)
        {
            ...
            //save settings
            _vendorPostHocSettings.AllowedTotalShippingCostChange = model.AllowedTotalShippingCostChange;
